...
export class LibraryBenefitsComponent
{
    public readonly benefits = [
        ...
        { title: 'Extendable',                         emoji: '🧩', description: 'Superpowers which allows your to create your own pluggable map extensions and share them with the world!' },
        { title: 'Testable',                           emoji: '🧪', description: 'Abstraction layer and testing modules facilitate mocking and testing.' },
