...
/** Provides the factory used to create a infowindow native for the `NativeFactory` token. */
export const NativeGoogleMapsInfoWindowFactoryProvider = createNativeFactoryProvider(() => new google.maps.InfoWindow());

/** Provides the factory used to create a infowindow wrapper for the `WrapperInstance` token. */
