...
import { GoogleMapsInfoWindowDirective, GoogleMapsOverlaysModule                     } from '@bespunky/angular-google-maps/overlays';
...
@Component({
    template: createLifecycleTestingHostComponentTemplate('<bs-google-maps-info-window [position]="center" #testedComponent></bs-google-maps-info-window>')
})
